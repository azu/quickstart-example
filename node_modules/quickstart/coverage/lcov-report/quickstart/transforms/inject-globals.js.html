...
<html lang="en">
<head>
    <title>Code coverage report for quickstart/transforms/inject-globals.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">quickstart/transforms/inject-globals.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">quickstart/transforms/</a> &#187; inject-globals.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!self.node &amp;&amp; !contains(variables, 'Buffer') &amp;&amp; contains(references, 'Buffer')) {
<span class="cstat-no" title="statement not covered" >    var bufferExpression = '(require("buffer").Buffer)';</span>
<span class="cstat-no" title="statement not covered" >    tree.body.splice(index++, 0, declaration('Buffer', express(bufferExpression)));</span>
  }
&nbsp;
  return tree;
}
