...
<html lang="en">
<head>
    <title>Code coverage report for quickstart/transforms/require-dependencies.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">quickstart/transforms/require-dependencies.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">91.94% <small>(57 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">quickstart/transforms/</a> &#187; require-dependencies.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">204</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">90797</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
      else <span class="missing-if-branch" title="if path not taken" >I</span>if (isLiteralJSONProp) <span class="cstat-no" title="statement not covered" >jsonNodes.push({</span>
        node: node,
        value: argument.value,
...
&nbsp;
      ...
      callee.object.name === 'require' &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >callee.property.type === Syntax.Identifier </span>&amp;&amp;
<span class="branch-4 cbranch-no" title="branch not covered" >      callee.property.name === 'resolve'</span>
    ) {
<span class="cstat-no" title="statement not covered" >      resolveNodes.push({</span>
        node: node,
        value: argument.value,
        parent: parent
      });
...
&nbsp;
  var resolveNodesPromise = sequence.every(resolveNodes, <span class="fstat-no" title="function not covered" >function(result) {</span>
<span class="cstat-no" title="statement not covered" >    var resolveNode = result.node;</span>
<span class="cstat-no" title="statement not covered" >    var resolveNodeValue = result.value;</span>
<span class="cstat-no" title="statement not covered" >    return self.require(pathogen(self.root + path), resolveNodeValue).then(<span class="fstat-no" title="function not covered" >function(uid) {</span></span>
<span class="cstat-no" title="statement not covered" >      resolveNode.arguments[0].value = uid; </span>// replace require.resolve argument
    });
  });
&nbsp;
...
&nbsp;
      for (key in jsonNodeParent) { // empty out the old node
        <span class="missing-if-branch" title="else path not taken" >E</span>if (key !== 'loc') delete jsonNodeParent[key];
      }
&nbsp;
